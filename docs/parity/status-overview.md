...
| [sync](sync/README.md) | Source re-audited: `6 Pass`, `1 Adapted Pass`, `4 Partial` | Focused unit/integration coverage, focused Sync UI coverage, explicit guardrails | Google Drive removal is tracked by #116, iCloud default preservation by #160, visible category toggle alignment by #158, and Android-only category implementation breadth by `ai_settings` (#74, blocked on #5/#89) and `progress` (#73, local model/UI bridge in place; remote sync pending) |
