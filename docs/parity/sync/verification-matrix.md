...
blocked on the iOS My Documents model/storage contract in #80 and the #51 bridge
disposition. The `ai_settings` category is blocked on the shared AI backend
direction in #5 and the #53/#89 bridge disposition. The `progress` category is
blocked on the iOS reading-progress model/storage and settings contract in #85
and the #52 bridge disposition.
