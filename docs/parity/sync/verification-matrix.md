...
disposition. The `progress` category is blocked on the iOS reading-progress
model/storage and settings contract in #85 and the #52 bridge disposition.
