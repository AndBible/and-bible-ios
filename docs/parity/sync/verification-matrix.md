...
`../bridge/my-documents-model.md` and remains blocked on local implementation
plus the #51 bridge disposition. The `ai_settings` category is blocked on the
