...
| Search route and direct-launch query retention for deterministic workflows | UI test `testSearchEntryRouteRetainsSeededQuery` | Pass | This protects Android destination chrome plus the test harness path used by deeper search regression coverage. |
